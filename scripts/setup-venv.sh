#!/usr/bin/env bash
#
# rms-polymath - Virtual Environment Bootstrap
#
# Creates the virtualenv that scripts/run-all-checks.sh expects and installs
# the project in editable mode with its development and documentation extras.
...
print_info "Installing rms-polymath with dev and docs extras"
