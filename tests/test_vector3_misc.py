...
class Test_Vector3_misc(unittest.TestCase):
    ...
    def runTest(self):
        ...
        self.assertEqual(vecs / Scalar(2), [[0.5,1,1.5],[1.5,2,2.5], [2.5,3,3.5]])
        ...
        self.assertRaises(ValueError, vecs.__truediv__, (1,2))
        self.assertRaises(TypeError, vecs.__truediv__, Pair((1,2)))
        ...
        self.assertRaises(TypeError, test.__itruediv__, Pair((1,2)))
        self.assertRaises(ValueError, test.__itruediv__, (1,2,3,4))
