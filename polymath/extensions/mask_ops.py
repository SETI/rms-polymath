...
class QubeMaskOps:
    """Mix-in class providing masking operations for Qube objects."""
    ...
    def mask_where_le(self, limit, replace=None, *, remask=True):
        ...
        limit = self._limit_from_qube(limit, masked=-np.inf, op='mask_where_le()')
    ...
    def mask_where_ge(self, limit, replace=None, *, remask=True):
        ...
        limit = self._limit_from_qube(limit, masked=np.inf, op='mask_where_ge()')
        return self.mask_where(self._values >= limit, replace=replace, remask=remask)
    ...
    def mask_where_lt(self, limit, replace=None, *, remask=True):
        ...
        limit = self._limit_from_qube(limit, masked=-np.inf, op='mask_where_lt()')
        return self.mask_where(self._values < limit, replace=replace, remask=remask)
    ...
    def mask_where_gt(self, limit, replace=None, *, remask=True):
        ...
        limit = self._limit_from_qube(limit, masked=np.inf, op='mask_where_gt()')
        return self.mask_where(self._values > limit, replace=replace, remask=remask)
    ...
    def mask_where_between(self, lower, upper, *, mask_endpoints=False, replace=None,
        ...
        lower = self._limit_from_qube(lower, masked=+np.inf, op='mask_where_between()')
        upper = self._limit_from_qube(upper, masked=-np.inf, op='mask_where_between()')
    ...
    def mask_where_outside(self, lower, upper, *, mask_endpoints=False, replace=None,
        ...
        lower = self._limit_from_qube(lower, masked=-np.inf, op='mask_where_outside()')
        upper = self._limit_from_qube(upper, masked=+np.inf, op='mask_where_outside()')
