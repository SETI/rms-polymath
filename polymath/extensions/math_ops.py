...
class QubeMathOps:
    ...
    def __abs__(self, *, recursive=True):
        ...
        QubeMathOps._raise_unsupported_op('abs()', self)
    ...
    def __add__(self, /, arg, *, recursive=True):
        ...
        if not isinstance(arg, Qube):
            try:
                ...
                QubeMathOps._raise_unsupported_op('+', self, original_arg)
        ...
        if self._numer != arg._numer:
            ...
            QubeMathOps._raise_incompatible_numers('+', self, arg)

        if self._denom != arg._denom:
            QubeMathOps._raise_incompatible_denoms('+', self, arg)
    ...
    def __mul__(self, /, arg, *, recursive=True):
        ...
        if self._drank and arg._drank:
            QubeMathOps._raise_dual_denoms('*', self, original_arg)
    ...
    def __rmul__(self, /, arg, *, recursive=True):
        ...
        # Revise the exception if the arg was modified
            ...
            if arg is not original_arg:
                QubeMathOps._raise_unsupported_op('*', original_arg, self)
            raise
    ...
    def __pow__(self, /, arg):
        ...
        if not isinstance(arg, numbers.Real):
            try:
                ...
                QubeMathOps._raise_unsupported_op('**', self, arg)
    ...
    def __le__(self, /, arg):
        ...
        QubeMathOps._raise_unsupported_op("<=", self)
    ...
    def reciprocal(self, *, recursive=True, nozeros=False):
        ...
        QubeMathOps._raise_unsupported_op('reciprocal()', self)
    ...
    def identity(self):
        ...
        QubeMathOps._raise_unsupported_op('identity()', self)
