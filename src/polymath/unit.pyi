...
class Unit:
    ...
    @staticmethod
    def div_units(arg1: Unit | None, arg2: Unit | None) -> Any: ...
    @staticmethod
    ...
    @staticmethod
    def mul_units(arg1: Unit | None, arg2: Unit | None) -> Any: ...
    @staticmethod
    def name_to_dict(expr: Any) -> dict[str, builtins.int]: ...
    @staticmethod
    ...
    def sqrt(self) -> Unit: ...
    @staticmethod
    def sqrt_unit(unit: Unit | None) -> Any: ...
    @staticmethod
    def unit_power(unit: Unit | None, power: float | builtins.int | bool) -> Any: ...
